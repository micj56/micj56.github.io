...
;
	...
	.set	tmr,0xFF000000		; timer base address
	.set	trm,0xFF001000		; terminal base address
...
tmrinit:
	...
	stw	$9,$8,0
	mvfs	$8,0
	or	$8,$8,1 << 13		; open timer IRQ mask bit
...
grinit:
	add	$8,$0,irqsrv
	ldw	$9,$8,4*17		; get old ISR for bus timeout
	add	$10,$0,grintrpt
	stw	$10,$8,4*17		; install new ISR
	stw	$0,$0,grf		; try to access frame buffer
	stw	$9,$8,4*17		; restore old ISR
	jr	$31
...
irqsrv:	.word	shmsg		; 00: unused
	.word	shmsg		; 01: unused
	.word	shmsg		; 02: unused
	.word	shmsg		; 03: unused
	.word	shmsg		; 04: terminal transmitter interrupt
	.word	shmsg		; 05: terminal receiver interrupt
	...
	.word	shmsg		; 13: timer interrupt
	.word	shmsg		; 14: unused
	.word	shmsg		; 15: unused
	.word	shmsg		; 16: bus address exception
	.word	shmsg		; 17: bus timeout exception
	.word	shmsg		; 18: illegal instruction exception
	.word	shmsg		; 19: privileged instruction exception
	.word	shmsg		; 20: trap instruction exception
	.word	shmsg		; 21: divide instruction exception
	.word	shmsg		; 22: TLB miss exception
	.word	shmsg		; 23: TLB double hit exception
	.word	shmsg		; 24: privileged address exception
	.word	shmsg		; 25: write protection exception
	...
	; message table
msgtbl:	.word	uimsg		; 00: unused
	.word	uimsg		; 01: unused
	.word	uimsg		; 02: unused
	.word	uimsg		; 03: unused
	.word	xmtmsg		; 04: terminal transmitter interrupt
	.word	rcvmsg		; 05: terminal receiver interrupt
	...
	.word	tmrmsg		; 13: timer interrupt
	.word	uimsg		; 14: unused
	.word	uimsg		; 15: unused
	.word	bamsg		; 16: bus address exception
	.word	btmsg		; 17: bus timeout exception
	.word	iimsg		; 18: illegal instruction exception
	.word	pimsg		; 19: privileged instruction exception
	.word	timsg		; 20: trap instruction exception
	.word	dimsg		; 21: divide instruction exception
	.word	msmsg		; 22: TLB miss exception
	.word	dhmsg		; 23: TLB double hit exception
	.word	pamsg		; 24: privileged address exception
	.word	wpmsg		; 25: write protection exception
...
bamsg:	.byte	"SPL/RTS: bus address exception"
	.byte	0x0D, 0x0A, 0
...
dhmsg:	.byte	"SPL/RTS: TLB double hit exception"
	.byte	0x0D, 0x0A, 0

pamsg:	.byte	"SPL/RTS: privileged address exception"
	.byte	0x0D, 0x0A, 0

wpmsg:	.byte	"SPL/RTS: write protection exception"
	.byte	0x0D, 0x0A, 0
